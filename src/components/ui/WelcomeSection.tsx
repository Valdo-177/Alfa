...
import welcome2 from '@/assets/welcomeImg2.png'
...
const WelcomeSection = () => {
    return (
        <section className='sm:h-[60rem] bg-white flex pb-[5rem] items-end justify-center'>
            <div className='container flex items-center justify-center gap-10 px-4 sm:px-0 pt-8'>
                ...
                <div>
                    ...
                    <div className='flex flex-col sm:flex-row items-center gap-8'>
                        <Image src={welcome2} alt='' className='w-[20rem]' />
